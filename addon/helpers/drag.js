...
import { triggerEvent, settled, find } from '@ember/test-helpers';
import { getOffset } from '../helpers/native';
/**
 * A re-implementation of the drag test helper that is compatible with the new qunit syntax without `registerAsyncHelper`.
 *
...
function deprecatedDrag(app, mode, itemSelector, offsetFn, callbacks = {}) {
...
export default registerAsyncHelper('drag', deprecatedDrag);
