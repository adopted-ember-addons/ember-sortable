...
export default class SortableItemModifier extends Modifier {
  ...
  keyDown(event) {
    ...
    if (event.target === handleElement || event.target === this.element) {
      this.sortableApi.activateKeyDown(this);
    } else {
      this.sortableApi.deactivateKeyDown();
    }
  }
  ...
  _scrollOnEdges(drag) {
    let groupDirection = this.sortableApi.getDirection();
  ...
  _makeDragHandler(startEvent) {
    const groupDirection = this.sortableApi.getDirection();
    let dragOrigin;
    let elementOrigin;
    let scrollOrigin;
  ...
  _drag(dimension) {
    ...
    throttle(this, this.sortableApi.update, updateInterval);
  }
  ...
  didReceiveArguments() {
    set(this, "sortableApi", this.args.named.api);
    set(this, "model", this.args.named.model);
    if (this.args.named.spacing !== undefined) {
      set(this, "spacing", this.args.named.spacing);
    }
    if (this.args.named.distance !== undefined) {
      set(this, "distance", this.args.named.distance);
    }
    if (this.args.named.handle !== undefined) {
      set(this, "handle", this.args.named.handle);
    }
    if (this.args.named.updateInterval !== undefined) {
      set(this, "updateInterval", this.args.named.updateInterval);
    }
    if (this.args.named.isDraggingDisabled !== undefined) {
      set(this, "isDraggingDisabled", this.args.named.isDraggingDisabled);
    }

    this.removeEventListener();
    this.addEventListener();
    this.sortableApi.registerItem(this);
  ...
  willRemove() {
    this.sortableApi.deregisterItem(this);
    this.removeEventListener();
  }
